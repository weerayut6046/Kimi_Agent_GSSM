...
- **ระบบสำรองและกู้คืนข้อมูล** - Admin สามารถเลือกส่งออกเฉพาะตารางที่ต้องการเป็นไฟล์ JSON และเลือกกู้คืนเฉพาะตารางจากไฟล์สำรองได้ รองรับ 22 ตาราง พร้อมระบบจัดการความสัมพันธ์ระหว่างตารางอัตโนมัติ
