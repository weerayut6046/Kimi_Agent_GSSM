...
- **สำรองและกู้คืนข้อมูล** - เลือกส่งออกเฉพาะตารางที่ต้องการเป็นไฟล์ JSON หรือเลือกกู้คืนเฉพาะตารางจากไฟล์สำรอง (เฉพาะ Admin) รองรับ 22 ตาราง
...
- **ระบบแจ้งเตือน** - แจ้งเตือนอัตโนมัติเมื่อมีคำขอลา คำขอสลับกะ ตารางกะอัปเดต แสดง badge unread และ dropdown อ่านทั้งหมด
